 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.math;
...
public final class Quaternion {
	...
	public Quaternion fromAngleAxis(double x, double y, double z, double angle) {
		...
		double l_ang = radians < 0 ? org.rajawali3d.math.MathUtil.TWO_PI - (-radians % org.rajawali3d.math.MathUtil.TWO_PI) : radians % org.rajawali3d.math.MathUtil.TWO_PI;
	 ...
	 *
	 * @param matrix {@link org.rajawali3d.math.Matrix4} The rotation matrix.
	 * @return A reference to this {@link Quaternion} to facilitate chaining.
	 */
	public Quaternion fromMatrix(org.rajawali3d.math.Matrix4 matrix) {
		double[] value = new double[16];
		matrix.toArray(value);
		fromAxes(value[org.rajawali3d.math.Matrix4.M00], value[org.rajawali3d.math.Matrix4.M01], value[org.rajawali3d.math.Matrix4.M02],
				value[org.rajawali3d.math.Matrix4.M10], value[org.rajawali3d.math.Matrix4.M11], value[org.rajawali3d.math.Matrix4.M12],
				value[org.rajawali3d.math.Matrix4.M20], value[org.rajawali3d.math.Matrix4.M21], value[org.rajawali3d.math.Matrix4.M22]);
		return this;
	}
	...
	public Quaternion fromRotationBetween(final Vector3 v1, final Vector3 v2) {
		final double dot = org.rajawali3d.math.MathUtil.clamp(v1.dot(v2), -1f, 1f);
	...
	public double getPitch() {
        normalize();
        final int pole = getGimbalPole();
        return pole == 0 ? Math.asin(org.rajawali3d.math.MathUtil.clamp(2.0 * (w * x - z * y), -1.0, 1.0)) : pole * org.rajawali3d.math.MathUtil.PI * 0.5;
	}
	...
	/**
	 * Creates a {@link org.rajawali3d.math.Matrix4} representing this {@link Quaternion}.
	 *
	 * @return {@link org.rajawali3d.math.Matrix4} representing this {@link Quaternion}.
	 */
	public org.rajawali3d.math.Matrix4 toRotationMatrix() {
		org.rajawali3d.math.Matrix4 matrix = new org.rajawali3d.math.Matrix4();
		toRotationMatrix(matrix);
		return matrix;
	}

	/**
	 * Sets the provided {@link org.rajawali3d.math.Matrix4} to represent this {@link Quaternion}.
	 */
	public org.rajawali3d.math.Matrix4 toRotationMatrix(org.rajawali3d.math.Matrix4 matrix) {
	...
	public void toRotationMatrix(double[] matrix) {
		...
		matrix[org.rajawali3d.math.Matrix4.M00] = 1.0 - 2.0 * (y2 + z2);
		matrix[org.rajawali3d.math.Matrix4.M10] = 2.0 * (xy - wz);
		matrix[org.rajawali3d.math.Matrix4.M20] = 2.0 * (xz + wy);
		matrix[org.rajawali3d.math.Matrix4.M30] = 0;

		matrix[org.rajawali3d.math.Matrix4.M01] = 2.0 * (xy + wz);
		matrix[org.rajawali3d.math.Matrix4.M11] = 1.0 - 2.0 * (x2 + z2);
		matrix[org.rajawali3d.math.Matrix4.M21] = 2.0 * (yz - wx);
		matrix[org.rajawali3d.math.Matrix4.M31] = 0;

		matrix[org.rajawali3d.math.Matrix4.M02] = 2.0 * (xz - wy);
		matrix[org.rajawali3d.math.Matrix4.M12] = 2.0 * (yz + wx);
		matrix[org.rajawali3d.math.Matrix4.M22] = 1.0 - 2.0 * (x2 + y2);
		matrix[org.rajawali3d.math.Matrix4.M32] = 0;

		matrix[org.rajawali3d.math.Matrix4.M03] = 0;
		matrix[org.rajawali3d.math.Matrix4.M13] = 0;
		matrix[org.rajawali3d.math.Matrix4.M23] = 0;
		matrix[org.rajawali3d.math.Matrix4.M33] = 1;
	}
	...
	public boolean equals(final Quaternion other, final double tolerance) {
		...
		return (Math.abs(angle) <= tolerance) || org.rajawali3d.math.MathUtil.realEqual(angle, org.rajawali3d.math.MathUtil.PI, tolerance);
	}
    ...
    public double angleBetween(final Quaternion other) {
        ...
        double angle = Math.acos(fCos);
        if (angle > org.rajawali3d.math.MathUtil.PI / 2) {
