 ...
 * per rendering cycle
 */
public class SkeletalAnimationChildObject3D extends org.rajawali3d.animation.mesh.AAnimationObject3D {
	public static final int MAX_WEIGHTS_PER_VERTEX = 8;

	public org.rajawali3d.animation.mesh.SkeletalAnimationObject3D mSkeleton;
	private org.rajawali3d.animation.mesh.SkeletalAnimationSequence mSequence;
	...
	public void setSkeleton(Object3D skeleton) {
		if (skeleton instanceof org.rajawali3d.animation.mesh.SkeletalAnimationObject3D) {
			mSkeleton = (org.rajawali3d.animation.mesh.SkeletalAnimationObject3D) skeleton;
		}
		else
	...
	public void play() {
		...
		for (Object3D child : mChildren)
		{
			if (child instanceof org.rajawali3d.animation.mesh.AAnimationObject3D)
				((org.rajawali3d.animation.mesh.AAnimationObject3D) child).play();
		}
	}
	...
	public void setMaxBoneWeightsPerVertex(int maxBoneWeightsPerVertex) throws SkeletalAnimationException
	{
		...
		if(mMaxBoneWeightsPerVertex > MAX_WEIGHTS_PER_VERTEX)
			throw new SkeletalAnimationException("A maximum of " + MAX_WEIGHTS_PER_VERTEX + " weights per vertex is allowed. Your model uses more then " + MAX_WEIGHTS_PER_VERTEX + ".");
	}
