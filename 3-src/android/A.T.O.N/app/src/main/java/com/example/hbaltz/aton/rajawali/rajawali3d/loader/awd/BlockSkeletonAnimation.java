 ...
 */
public class BlockSkeletonAnimation extends org.rajawali3d.loader.awd.ABlockParser {
	...
	private SkeletalAnimationFrame lookup(BlockHeader blockHeader, long addr) throws ParsingException
	{
		...
		if (lookupHeader == null || lookupHeader.parser == null
				|| !(lookupHeader.parser instanceof org.rajawali3d.loader.awd.BlockSkeletonPose))
