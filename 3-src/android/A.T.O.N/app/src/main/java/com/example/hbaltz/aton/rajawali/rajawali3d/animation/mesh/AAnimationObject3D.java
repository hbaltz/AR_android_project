...
public abstract class AAnimationObject3D extends Object3D {
	...
	protected Stack<org.rajawali3d.animation.mesh.IAnimationFrame> mFrames;
	...
	public AAnimationObject3D() {
		super();
		mFrames = new Stack<org.rajawali3d.animation.mesh.IAnimationFrame>();
	}
	...
	public void addFrame(org.rajawali3d.animation.mesh.IAnimationFrame frame) {
		mFrames.add(frame);
		mNumFrames++;
	}
	...
	public org.rajawali3d.animation.mesh.IAnimationFrame getFrame(int index) {
		return mFrames.get(index);
	}

	public void setFrames(Stack<org.rajawali3d.animation.mesh.IAnimationFrame> frames) {
		mFrames = frames;
		frames.trimToSize();
		mNumFrames = frames.capacity();
	}

	public void setFrames(org.rajawali3d.animation.mesh.IAnimationFrame[] frames) {
		Stack<org.rajawali3d.animation.mesh.IAnimationFrame> f = new Stack<org.rajawali3d.animation.mesh.IAnimationFrame>();
