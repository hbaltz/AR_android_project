...
public class Angle {
	 ...
	 * the given point.
	 */
	public static double horizontalAngle(Point point) {
	 ...
	 * points.
	 */
	public static double horizontalAngle(Point p1,	Point p2) {
	 ...
	 */
	public static double pseudoAngle(Point p1, Point p2) {
		double dx = p2.x - p1.x;
		double dy = p2.y - p1.y;
