...
import org.rajawali3d.loader.awd.*;
 ...
 * 
 */
public class BlockSimpleMaterial extends org.rajawali3d.loader.awd.ATextureBlockParser {
	...
	private Bitmap lookup(BlockHeader blockHeader, long texref) throws ParsingException
	{
		...
		if (lookupHeader == null || lookupHeader.parser == null
				|| !(lookupHeader.parser instanceof org.rajawali3d.loader.awd.BlockBitmapTexture))
