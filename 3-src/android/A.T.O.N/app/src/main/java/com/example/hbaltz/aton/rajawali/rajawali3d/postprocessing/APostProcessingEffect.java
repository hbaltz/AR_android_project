...
public abstract class APostProcessingEffect implements IPostProcessingEffect {
	...
	@Override
	public org.rajawali3d.postprocessing.IPass addPass(org.rajawali3d.postprocessing.IPass pass) {
		if(mPasses == null) mPasses = new ArrayList<org.rajawali3d.postprocessing.IPass>();
		mPasses.add(pass);
		return pass;
	}

	@Override
	public List<org.rajawali3d.postprocessing.IPass> getPasses() {
		return mPasses;
	}
