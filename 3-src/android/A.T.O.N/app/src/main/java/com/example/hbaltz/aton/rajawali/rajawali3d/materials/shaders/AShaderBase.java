 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.materials.shaders;


import org.rajawali3d.materials.shaders.*;
...
public abstract class AShaderBase {
	 ...
	 * by custom shaders as well. When one of these variables is required the {@link org.rajawali3d.materials.shaders.AShader#getGlobal(IGlobalShaderVar)}
	 ...
	 * The {@link org.rajawali3d.materials.shaders.AShader} class uses ShaderVars to write a text file under the hood.
