 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.curves;

import java.util.Stack;

import org.rajawali3d.curves.*;
import org.rajawali3d.math.vector.Vector3;

public class CompoundCurve3D implements org.rajawali3d.curves.ICurve3D {
	protected static final double DELTA = .000001;
	
	protected Stack<org.rajawali3d.curves.ICurve3D> mCurves;
	protected int mNumCurves;
	protected org.rajawali3d.curves.ICurve3D mCurrentCurve;

	public CompoundCurve3D() {
		mCurves = new Stack<org.rajawali3d.curves.ICurve3D>();
	}

	public void addCurve(org.rajawali3d.curves.ICurve3D curve) {
		mCurves.add(curve);
		mNumCurves++;
	}
