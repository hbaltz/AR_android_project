 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d;
...
public class Geometry3D {
	 ...
	 */
	protected org.rajawali3d.BufferInfo mVertexBufferInfo;
	/**
	 * Index buffer info object.
	 */
	protected org.rajawali3d.BufferInfo mIndexBufferInfo;
	/**
	 * Texture coordinate buffer info object.
	 */
	protected org.rajawali3d.BufferInfo mTexCoordBufferInfo;
	/**
	 * Color buffer info object.
	 */
	protected org.rajawali3d.BufferInfo mColorBufferInfo;
	/**
	 * Normal buffer info object.
	 */
	protected org.rajawali3d.BufferInfo mNormalBufferInfo;
	...
	public Geometry3D() {
        ...
        mVertexBufferInfo = new org.rajawali3d.BufferInfo();
        mIndexBufferInfo = new org.rajawali3d.BufferInfo();
        mTexCoordBufferInfo = new org.rajawali3d.BufferInfo();
        mColorBufferInfo = new org.rajawali3d.BufferInfo();
        mNormalBufferInfo = new org.rajawali3d.BufferInfo();
	}
	 ...
	 */
	public void setData(org.rajawali3d.BufferInfo vertexBufferInfo, org.rajawali3d.BufferInfo normalBufferInfo,
	 ...
	 * @param target
	 */
	public void createBuffer(org.rajawali3d.BufferInfo bufferInfo, BufferType type, Buffer buffer, int target) {
     ...
     * @param usage
     */
    public void createBuffer(org.rajawali3d.BufferInfo bufferInfo, BufferType type, Buffer buffer, int target, int usage) {
	...
	public void createBuffer(org.rajawali3d.BufferInfo bufferInfo) {
	 ...
	 * @param usage
	 */
	public void changeBufferUsage(org.rajawali3d.BufferInfo bufferInfo, final int usage) {
     ...
     * @param index
     */
    public void changeBufferData(org.rajawali3d.BufferInfo bufferInfo, Buffer newData, int index) {
     ...
     * @param size
     */
    public void changeBufferData(org.rajawali3d.BufferInfo bufferInfo, Buffer newData, int index, int size) {
     ...
     * @param resizeBuffer
     */
    public void changeBufferData(org.rajawali3d.BufferInfo bufferInfo, Buffer newData, int index, boolean resizeBuffer) {
     ...
     * @param resizeBuffer
     */
	public void changeBufferData(org.rajawali3d.BufferInfo bufferInfo, Buffer newData, int index, int size, boolean resizeBuffer) {
		newData.rewind();
	...
	public org.rajawali3d.BufferInfo getVertexBufferInfo() {
		return mVertexBufferInfo;
	}

	public void setVertexBufferInfo(org.rajawali3d.BufferInfo vertexBufferInfo) {
		this.mVertexBufferInfo = vertexBufferInfo;
	}

	public org.rajawali3d.BufferInfo getIndexBufferInfo() {
		return mIndexBufferInfo;
	}

	public void setIndexBufferInfo(org.rajawali3d.BufferInfo indexBufferInfo) {
		this.mIndexBufferInfo = indexBufferInfo;
	}

	public org.rajawali3d.BufferInfo getTexCoordBufferInfo() {
		return mTexCoordBufferInfo;
	}

	public void setTexCoordBufferInfo(org.rajawali3d.BufferInfo texCoordBufferInfo) {
		this.mTexCoordBufferInfo = texCoordBufferInfo;
        this.mHasTextureCoordinates = true;
	}

	public org.rajawali3d.BufferInfo getColorBufferInfo() {
		return mColorBufferInfo;
	}

	public void setColorBufferInfo(org.rajawali3d.BufferInfo colorBufferInfo) {
		this.mColorBufferInfo = colorBufferInfo;
	}

	public org.rajawali3d.BufferInfo getNormalBufferInfo() {
		return mNormalBufferInfo;
	}

	public void setNormalBufferInfo(org.rajawali3d.BufferInfo normalBufferInfo) {
