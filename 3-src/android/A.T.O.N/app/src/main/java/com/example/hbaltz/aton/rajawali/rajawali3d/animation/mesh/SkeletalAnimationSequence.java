 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.animation.mesh;

import java.util.ArrayList;
import java.util.List;

import org.rajawali3d.animation.mesh.*;
...
public class SkeletalAnimationSequence implements org.rajawali3d.animation.mesh.IAnimationSequence {
	private org.rajawali3d.animation.mesh.SkeletalAnimationFrame[] mFrames;
	...
	public void setFrames(org.rajawali3d.animation.mesh.SkeletalAnimationFrame[] frames)
	{
		mFrames = frames;
		mNumFrames = frames.length;
	}
	
	public org.rajawali3d.animation.mesh.SkeletalAnimationFrame[] getFrames()
	{
		return mFrames;
	}
	
	public org.rajawali3d.animation.mesh.SkeletalAnimationFrame getFrame(int index)
	{
	...
	public void blendWith(SkeletalAnimationSequence otherSequence, double blendFactor) throws SkeletalAnimationException
	{
		...
		List<org.rajawali3d.animation.mesh.SkeletalAnimationFrame> newFrames = new ArrayList<org.rajawali3d.animation.mesh.SkeletalAnimationFrame>();
		...
		for(int i=0; i<numFrames; i++)
		{
			...
			org.rajawali3d.animation.mesh.SkeletalAnimationFrame thisFrame = getFrame(i);
			org.rajawali3d.animation.mesh.SkeletalAnimationFrame otherFrame = otherSequence.getFrame(i);
			org.rajawali3d.animation.mesh.SkeletalAnimationFrame newFrame = new org.rajawali3d.animation.mesh.SkeletalAnimationFrame();
			
			int numJoints = thisFrame.getSkeleton().getJoints().length;
			
			if(numJoints != otherFrame.getSkeleton().getJoints().length)
				throw new SkeletalAnimationException("The animation sequences you want to blend have different skeletons.");
