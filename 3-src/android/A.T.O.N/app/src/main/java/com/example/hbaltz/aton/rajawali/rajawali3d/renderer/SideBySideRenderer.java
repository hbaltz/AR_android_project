 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.renderer;
...
public abstract class SideBySideRenderer extends Renderer {
	 ...
	 */
	private org.rajawali3d.renderer.RenderTarget mLeftRenderTarget;
	/**
	 * The texture that will be used to render the scene into from the
	 * perspective of the right eye.
	 */
	private org.rajawali3d.renderer.RenderTarget mRightRenderTarget;
	/**
	...
	public void initScene() {
		...
		mLeftRenderTarget = new org.rajawali3d.renderer.RenderTarget("sbsLeftRT", mViewportWidthHalf, mDefaultViewportHeight);
		mLeftRenderTarget.setFullscreen(false);
		mRightRenderTarget = new org.rajawali3d.renderer.RenderTarget("sbsRightRT", mViewportWidthHalf, mDefaultViewportHeight);
