...
public final class Matrix4 {
	...
	public Matrix4 inverse() {
        boolean success = org.rajawali3d.math.Matrix.invertM(mTmp, 0, m, 0);
	...
	public Matrix4 transpose() {
		org.rajawali3d.math.Matrix.transposeM(mTmp, 0, m, 0);
		System.arraycopy(mTmp, 0, m, 0, 16);
		return this;
    }
	...
	/**
	 * Multiplies this {@link Matrix4} with the given one, storing the result in this {@link org.rajawali3d.math.Matrix}.
	 * <pre>
	...
	public Matrix4 multiply(final Matrix4 matrix) {
		...
		org.rajawali3d.math.Matrix.multiplyMM(m, 0, mTmp, 0, matrix.getDoubleValues(), 0);
		return this;
    }
	
	/**
	 * Left multiplies this {@link Matrix4} with the given one, storing the result in this {@link org.rajawali3d.math.Matrix}.
	 * <pre>
	...
	public Matrix4 leftMultiply(final Matrix4 matrix) {
		System.arraycopy(m, 0, mTmp, 0, 16);
		org.rajawali3d.math.Matrix.multiplyMM(m, 0, matrix.getDoubleValues(), 0, mTmp, 0);
		return this;
	}
	...
	public Matrix4 scale(double x, double y, double z) {
		org.rajawali3d.math.Matrix.scaleM(m, 0, x, y, z);
		return this;
	}
	...
	public Matrix4 setToPerspective(double near, double far, double fov, double aspect) {
		identity();
		org.rajawali3d.math.Matrix.perspectiveM(m, 0, fov, aspect, near, far);
		return this;
	}
	...
	public Matrix4 setToOrthographic(double left, double right, double bottom, double top, double near, double far) {
		org.rajawali3d.math.Matrix.orthoM(m, 0, left, right, bottom, top, near, far);
		return this;
	}
	...
	public Matrix4 setToLookAt(final Vector3 position, final Vector3 target, final Vector3 up) {
		org.rajawali3d.math.Matrix.setLookAtM(m, 0, position.x, position.y, position.z,
