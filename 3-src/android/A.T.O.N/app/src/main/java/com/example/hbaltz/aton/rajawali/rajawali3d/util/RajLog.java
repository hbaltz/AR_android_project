 ...
 */
package com.example.hbaltz.aton.rajawali.rajawali3d.util;
...
public final class RajLog {
    ...
    public static void checkGLError(String message) {
        ...
        if (error > 0)
            throw new RuntimeException("OpenGL Error: " + org.rajawali3d.util.GLU.gluErrorString(error) + " " + error + " | " + message);
    }
