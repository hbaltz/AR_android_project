...
public class SkeletalAnimationObject3D extends org.rajawali3d.animation.mesh.AAnimationObject3D {
	...
	public void setShaderParams(Camera camera) {
		...
		org.rajawali3d.animation.mesh.SkeletalAnimationFrame currentFrame = (org.rajawali3d.animation.mesh.SkeletalAnimationFrame) mSequence.getFrame(mCurrentFrameIndex);
		org.rajawali3d.animation.mesh.SkeletalAnimationFrame nextFrame = (org.rajawali3d.animation.mesh.SkeletalAnimationFrame) mSequence.getFrame((mCurrentFrameIndex + 1) % mSequence.getNumFrames());
		...
		for (int i = 0; i < mJoints.length; ++i) {
			...
			if(isTransitioning)
			{
				org.rajawali3d.animation.mesh.SkeletalAnimationFrame currentTransFrame = mNextSequence.getFrame(mCurrentTransitionFrameIndex % mNextSequence.getNumFrames());
				org.rajawali3d.animation.mesh.SkeletalAnimationFrame nextTransFrame = mNextSequence.getFrame((mCurrentTransitionFrameIndex + 1) % mNextSequence.getNumFrames());
	...
	public void play() {
		...
		super.play();
		for (Object3D child : mChildren)
			if (child instanceof org.rajawali3d.animation.mesh.AAnimationObject3D)
